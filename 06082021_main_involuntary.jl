...
function parameters_function(;
    ...
    a_min::Real = -16.0,            # min of asset holding
...
function min_bounds_function(obj::Function, grid_min::Real, grid_max::Real; grid_length::Integer = 200, obj_range::Integer = 1)
    """
    ...
    for e_i = 1:e_size, t_i = 1:t_size, ν_i = 1:ν_size
        ...
        Threads.@threads for a_i = 1:a_size
            ...
            if (CoH - rbl_qa) > 0.0
                ...
                =#
                if ν == 0.0
                    @inbounds variables.V_nd[a_i, e_i, t_i, ν_i] = -object_nd(rbl_a)
                    @inbounds variables.policy_a[a_i, e_i, t_i, ν_i] = rbl_a
                    @inbounds variables.V[a_i, e_i, t_i, ν_i] = variables.V_nd[a_i, e_i, t_i, ν_i]
                else
                    lb, ub = min_bounds_function(object_nd, rbl_a, CoH)

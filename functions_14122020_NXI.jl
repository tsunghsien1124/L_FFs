...
function price_func!(
    ...
    Threads.@threads for a_p_i in 1:(a_size_neg-1)
        ...
        for e_i in 1:e_size
            ...
            repay_prob_1, err1 = quadgk(x -> kernel_repay_1(x), e_p_thres_ξ_bar_1, Inf) # , order=100, rtol=1E-10
            repay_prob_2, err2 = quadgk(x -> kernel_repay_2(x), e_p_thres_ξ_bar_2, Inf)
            ...
            default_prob_1, err1 = quadgk(x -> kernel_default_1(x), -Inf, e_p_thres_zero_1)
            default_prob_2, err2 = quadgk(x -> kernel_default_2(x), -Inf, e_p_thres_zero_2)

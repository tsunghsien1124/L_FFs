...
Indicator_solve_stationary_equlibria_across_p_h_θ = false
...
Indicator_solve_transitional_dynamics_across_η_higher_θ_1_same_benchmark = false
Indicator_solve_transitional_dynamics_across_η_lower_θ_1 = false
Indicator_solve_transitional_dynamics_across_η_lower_θ_1_same_benchmark = false
...
if Indicator_solve_stationary_equlibria_across_p_h_θ == true
...
if Indicator_solve_transitional_dynamics_across_η_higher_θ_1_same_benchmark == true

    # specily the benchmark
    @load "results_eta.jld2" var_names results_A_NFF results_V_NFF results_V_pos_NFF results_μ_NFF results_A_FF results_V_FF results_V_pos_FF results_μ_FF
    η_25, λ_25 = results_A_FF[1, 2], results_A_FF[3, 2] # η = 0.25
    ...
    # save results
    CSV.write("results_equilibria_across_eta_1.01_theta_same_benchmark.csv", Tables.table(results_equilibria_across_η), header=false)
    ...
    load_initial_value = true
    if load_initial_value == true
        @load "results_transition_eta_1.01_theta_same_benchmark.jld2" transition_path_eta_25_30 transition_path_eta_25_20
    end
    initial_z = ones(T_size + 2)
    ...
    plot_transition_path_eta_25_30 = plot!(transition_path_eta_25_30, linecolor=:blue, linewidth=3, markershapes=:circle, markercolor=:blue, markersize=6, markerstrokecolor=:blue, label=:none)
    plot_transition_path_eta_25_30
    Plots.savefig(plot_transition_path_eta_25_30, pwd() * "\\figures\\plot_transition_path_eta_25_30_1.01_theta_same_benchmark.pdf")
    ...
    plot_transition_path_eta_25_20 = plot(size=(800, 500), box=:on, legend=:bottomright, xtickfont=font(18, "Computer Modern", :black), ytickfont=font(18, "Computer Modern", :black), titlefont=font(18, "Computer Modern", :black), guidefont=font(18, "Computer Modern", :black), legendfont=font(18, "Computer Modern", :black), margin=4mm, ylabel="", xlabel="Time")
    plot_transition_path_eta_25_20 = plot!(transition_path_eta_25_20, linecolor=:blue, linewidth=3, markershapes=:circle, markercolor=:blue, markersize=6, markerstrokecolor=:blue, label=:none)
    Plots.savefig(plot_transition_path_eta_25_20, pwd() * "\\figures\\plot_transition_path_eta_25_20_1.01_theta_same_benchmark.pdf")

    # save transition path
    @save "results_transition_eta_1.01_theta_same_benchmark.jld2" transition_path_eta_25_30 transition_path_eta_25_20
    ...
    # save results
    CSV.write("results_welfare_across_eta_1.01_theta_same_benchmark.csv", Tables.table(results_welfare_across_η), header=false)
...
if Indicator_solve_transitional_dynamics_across_η_lower_θ_1_same_benchmark == true
    ...
    # save results
    CSV.write("results_equilibria_across_eta_0.99_theta_same_benchmark.csv", Tables.table(results_equilibria_across_η), header=false)
    ...
    load_initial_value = true
    if load_initial_value == true
        @load "results_transition_eta_0.99_theta_same_benchmark.jld2" transition_path_eta_25_30 transition_path_eta_25_20
    end
    initial_z = ones(T_size + 2)
    ...
    plot_transition_path_eta_25_30 = plot!(transition_path_eta_25_30, linecolor=:blue, linewidth=3, markershapes=:circle, markercolor=:blue, markersize=6, markerstrokecolor=:blue, label=:none)
    plot_transition_path_eta_25_30
    Plots.savefig(plot_transition_path_eta_25_30, pwd() * "\\figures\\plot_transition_path_eta_25_30_0.99_theta_same_benchmark.pdf")
    ...
    plot_transition_path_eta_25_20 = plot(size=(800, 500), box=:on, legend=:bottomright, xtickfont=font(18, "Computer Modern", :black), ytickfont=font(18, "Computer Modern", :black), titlefont=font(18, "Computer Modern", :black), guidefont=font(18, "Computer Modern", :black), legendfont=font(18, "Computer Modern", :black), margin=4mm, ylabel="", xlabel="Time")
    plot_transition_path_eta_25_20 = plot!(transition_path_eta_25_20, linecolor=:blue, linewidth=3, markershapes=:circle, markercolor=:blue, markersize=6, markerstrokecolor=:blue, label=:none)
    Plots.savefig(plot_transition_path_eta_25_20, pwd() * "\\figures\\plot_transition_path_eta_25_20_0.99_theta_same_benchmark.pdf")

    # save transition path
    @save "results_transition_eta_0.99_theta_same_benchmark.jld2" transition_path_eta_25_30 transition_path_eta_25_20
    ...
    # save results
    CSV.write("results_welfare_across_eta_0.99_theta_same_benchmark.csv", Tables.table(results_welfare_across_η), header=false)
...
if Indicator_solve_transitional_dynamics_across_p_h == true
    ...
    # compute welfare metrics from p_h = 1/10 to p_h = 1/8
